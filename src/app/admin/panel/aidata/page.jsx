                ...
                >
                    ...
                    <div className="w-[90%] mx-auto flex gap-[5%] justify-between items-center">
                        ...
                        <button
                            ...
                            className="px-[1.7rem] py-[0.7rem] rounded-lg w-[48%] border-2 border-[var(--accent-color)] text-[var(--text-color)] bg-[var(--accent-color)] font-[580] cursor-pointer hoverLight soft transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {upsertLoading ? 'Upserting...' : 'Upsert Data'}
                        </button>
                    </div>
                </form>
            </Modal>
